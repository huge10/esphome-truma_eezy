...
#include "TrumaEezyApp.h"

namespace esphome {
namespace truma_eezy {

template<typename... Ts> class HeaterRoomTempAction : public Action<Ts...>, public Parented<TrumaEezyApp> {
 public:
...
template<typename... Ts> class HeaterWaterTempAction : public Action<Ts...>, public Parented<TrumaEezyApp> {
 public:
  TEMPLATABLE_VALUE(u_int8_t, temperature)
...
template<typename... Ts> class HeaterWaterTempEnumAction : public Action<Ts...>, public Parented<TrumaEezyApp> {
 public:
...
template<typename... Ts> class HeaterElecPowerLevelAction : public Action<Ts...>, public Parented<TrumaEezyApp> {
 public:
...
template<typename... Ts> class HeaterEnergyMixAction : public Action<Ts...>, public Parented<TrumaEezyApp> {
 public:
...
template<typename... Ts> class AirconManualTempAction : public Action<Ts...>, public Parented<TrumaEezyApp> {
 public:
  TEMPLATABLE_VALUE(u_int8_t, temperature)
...
template<typename... Ts> class TimerDisableAction : public Action<Ts...>, public Parented<TrumaEezyApp> {
 public:
  void play(Ts... x) override { this->parent_->get_timer()->action_timer_disable(); }
};

template<typename... Ts> class TimerActivateAction : public Action<Ts...>, public Parented<TrumaEezyApp> {
 public:
...
#ifdef USE_TIME
template<typename... Ts> class WriteTimeAction : public Action<Ts...>, public Parented<TrumaEezyApp> {
 public:
  void play(Ts... x) override { this->parent_->get_clock()->action_write_time(); }
};
#endif  // USE_TIME

class TrumaEezyAppHeaterMessageTrigger : public Trigger<const StatusFrameHeater *> {
 public:
  explicit TrumaEezyAppHeaterMessageTrigger(TrumaEezyApp *parent) {
