...
static const char *const TAG = "truma_eezy.TrumaEezyAppTimer";

StatusFrameTimerResponse *TrumaEezyAppTimer::update_prepare() {
...
void TrumaEezyAppTimer::create_update_data(StatusFrame *response, u_int8_t *response_len, u_int8_t command_counter) {
...
void TrumaEezyAppTimer::dump_data() const {
...
bool TrumaEezyAppTimer::action_timer_disable() {
  if (!this->can_update()) {
...
bool TrumaEezyAppTimer::action_timer_activate(u_int16_t start, u_int16_t stop, u_int8_t room_temperature,
