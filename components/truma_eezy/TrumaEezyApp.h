...
#include "TrumaEezyAppAirconAuto.h"
#include "TrumaEezyAppAirconManual.h"
#include "TrumaEezyAppClock.h"
#include "TrumaEezyAppConfig.h"
#include "TrumaEezyAppHeater.h"
#include "TrumaEezyAppTimer.h"
...
class TrumaEezyApp : public LinBusProtocol {
 public:
  TrumaEezyApp();
  ...
  TrumaEezyAppAirconAuto *get_aircon_auto() { return &this->airconAuto_; }
  TrumaEezyAppAirconManual *get_aircon_manual() { return &this->airconManual_; }
  TrumaEezyAppClock *get_clock() { return &this->clock_; }
  TrumaEezyAppConfig *get_config() { return &this->config_; }
  TrumaEezyAppHeater *get_heater() { return &this->heater_; }
  TrumaEezyAppTimer *get_timer() { return &this->timer_; }
 ...
 protected:
  ...
  TrumaEezyAppAirconAuto airconAuto_;
  TrumaEezyAppAirconManual airconManual_;
  TrumaEezyAppClock clock_;
  TrumaEezyAppConfig config_;
  TrumaEezyAppHeater heater_;
  TrumaEezyAppTimer timer_;
