...
static const char *const TAG = "truma_eezy.TrumaEezyAppAirconManual";

StatusFrameAirconManualResponse *TrumaEezyAppAirconManual::update_prepare() {
...
void TrumaEezyAppAirconManual::create_update_data(StatusFrame *response, u_int8_t *response_len,
...
void TrumaEezyAppAirconManual::dump_data() const {}

bool TrumaEezyAppAirconManual::can_update() {
...
bool TrumaEezyAppAirconManual::action_set_temp(u_int8_t temperature) {
  if (!this->can_update()) {
