...
TrumaNumber = truma_eezy_ns.class_(
    "TrumaNumber", number.Number, cg.Component)

# `TRUMA_NUMBER_TYPE` is a enum class and not a namespace but it works.
TRUMA_NUMBER_TYPE_dummy_ns = truma_eezy_ns.namespace("TRUMA_NUMBER_TYPE")

CONF_SUPPORTED_TYPE = {
    "TARGET_ROOM_TEMPERATURE": {
        CONF_CLASS: truma_eezy_ns.class_("TrumaHeaterNumber", number.Number, cg.Component),
    ...
    "AIRCON_MANUAL_TEMPERATURE": {
        CONF_CLASS: truma_eezy_ns.class_("TrumaAirconManualNumber", number.Number, cg.Component),
