...
static const char *const TAG = "truma_eezy.TrumaEezyAppAirconAuto";

StatusFrameAirconAutoResponse *TrumaEezyAppAirconAuto::update_prepare() {
...
void TrumaEezyAppAirconAuto::create_update_data(StatusFrame *response, u_int8_t *response_len,
...
void TrumaEezyAppAirconAuto::dump_data() const {}

bool TrumaEezyAppAirconAuto::can_update() {
