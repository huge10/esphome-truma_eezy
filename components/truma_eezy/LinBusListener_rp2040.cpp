...
static esphome::truma_eezy::LinBusListener *LIN_BUS_LISTENER_INSTANCE_1 = nullptr;
// Instance 2 for UART port 1
static esphome::truma_eezy::LinBusListener *LIN_BUS_LISTENER_INSTANCE_2 = nullptr;

namespace esphome {
namespace truma_eezy {

static const char *const TAG = "truma_eezy.LinBusListener";
